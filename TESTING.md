...
the Import Pugin button, which usually is sufficient to test a plugin.
...
will be used when copied to the User config path as described in
https://github.com/leamas/OpenCPN/wiki/Terminology. The new catalog
